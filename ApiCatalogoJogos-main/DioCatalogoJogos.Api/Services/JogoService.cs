...
using DioCatalogoJogos.Api.Repositories;
using DioCatalogoJogos.Api.ViewModel;
using DioCatalogoJogos.Api.Services;
using DioCatalogoJogos.Api.Exceptions;
using System;
using System.Collections.Generic;
using System.Linq;
using System.Threading.Tasks;
using DioCatalogoJogos.Api.entities;
...
namespace ExemploApiCatalogoJogos.Services
{
    public class JogoService : IJogoService
    {
        ...
        public Task<JogoViewModel> Inserir(Guid id, JogoInputModel jogo)
        {
            throw new NotImplementedException();
        }

        Task IJogoService.Inserir(JogoInputModel jogoInputModel)
        {
            throw new NotImplementedException();
        }
    }
